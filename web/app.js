...
const I18N = {
  ru: {
    ...
    note_kufar_only: "Пока работает только поиск аренды на Kufar.",
  ...
  by: {
    ...
    add_hint:
      "Наладзь фільтры на Kufar, скапіруй спасылку пошуку і ўстаў сюды — далей бот сам прышле новыя аб'явы.",
    link_label: "Спасылка",
    ...
    note_kufar_only: "Пакуль працуе толькі пошук арэнды на Kufar.",
